        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p
              ...
              data-aos-duration="1500"
            >
               a Computer Science Engineering student with a passion for creating clean, functional, and visually engaging web applications. Currently pursuing my B.E. in CSE, I enjoy working on full-stack projects that combine creative UI/UX design with efficient backend logic. I’ve built applications using technologies like React.js, Tailwind CSS, Node.js, Express, and MongoDB, and I’m comfortable with tools like Git, Figma, Postman, and Vite. I’m always eager to learn new frameworks and build impactful solutions that solve real-world problems.</p>
